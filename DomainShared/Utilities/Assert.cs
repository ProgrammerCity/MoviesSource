...
namespace DomainShared.Utilities
{
    ...
    {
        public static void NotNull<T>(T obj, string name, string message = default!)
            where T : class
        {
            if (obj is null)
        ...
        public static void NotEmpty<T>(T obj, string name, string message = default!, T defaultValue = default!)
            where T : class
        {
            if (obj == defaultValue
